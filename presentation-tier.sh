...
APP_TIER_ALB_URL="http://internal-application-tier-alb-49273590.us-east-1.elb.amazonaws.com"  # Replace with your actual alb endpoint
API_URL="/api"
...
SERVER_NAME="richardaguirre.cloud www.richardaguirre.cloud"  # Replace with your actual domain name
